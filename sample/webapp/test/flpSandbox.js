		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comgyansyssample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgyansyssample-display": {
								"semanticObject": "comgyansyssample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gyansys.sample",
									"url": sap.ui.require.toUrl("com/gyansys/sample")
								}
							}
						}
					}
