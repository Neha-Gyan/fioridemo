		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World",
									"targetURL": "#comgyansyshelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgyansyshelloworld-display": {
								"semanticObject": "comgyansyshelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gyansys.helloworld",
									"url": sap.ui.require.toUrl("com/gyansys/helloworld")
								}
							}
						}
					}
